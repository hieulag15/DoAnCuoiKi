...
void frameNULL(int x, int y, int i, int j, const char* mess)
{
	line(x, y, x + i, y);
	line(x, y, x, y + j);
	line(x, y + j, x + i, y + j);
	...
	line(x + 180, y, x + i + 180, y);
	line(x + 180, y, x + 180, y + j);
	line(x + 180, y + j, x + i + 180, y + j);
	line(x + i + 180, y, x + i + 180, y + j);
	drawText(x + 180 + 23, y - 15, "NULL");
}
