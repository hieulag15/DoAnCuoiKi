...
void frame(int x, int y, int i, int j, const char* mess, int color)
{
	setcolor(color);
	line(x, y, x + i, y);
	line(x, y, x, y + j);
	line(x, y + j, x + i, y + j);
	line(x + i, y, x + i, y + j);
	drawText(x + 18, y + 17, mess);
}

void frameLK(int x, int y, int i, int j, int color)
{
	setcolor(color);
	line(x, y, x + i, y);
	line(x, y, x, y + j);
	line(x, y + j, x + i, y + j);
	line(x + i, y, x + i, y + j);
	line(x + (i / 2), y + (j / 2), x + (i / 2), y + j + 80);
	circle(x + (i / 2), y + (j / 2), 10);
	line(x + (i / 2), y + j + 78, x + (i / 2) + 7, y + j + 70);
	line(x + (i / 2), y + j + 78, x + (i / 2) - 7, y + j + 70);
}

void frameGound(int x, int y, int i, int j, int color)
{
	setcolor(color);
	line(x, y, x + i, y);
	line(x, y, x, y + j);
	line(x, y + j, x + i, y + j);
	line(x + i, y, x + i, y + j);
	line(x + (i / 2), y + (j / 2), x + (i / 2), y + j + 70);
	circle(x + (i / 2), y + (j / 2), 10);
	line(x + (i/2) - 20, y + j + 70, x + (i/2) + 20, y + j + 70);
	line(x + (i / 2) - 15, y + j + 75, x + (i / 2) + 15, y + j + 75);
	line(x + (i / 2) - 10, y + j + 80, x + (i / 2) + 10, y + j + 80);
}
