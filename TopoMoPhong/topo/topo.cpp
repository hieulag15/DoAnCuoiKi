...
int main()
{
	...
	for (int i = 1; i <= n; i++)
	{
		...
		frame(200 + i*ngang, 200, 60, 60, "0", 15);
	...
	frame(220 + (n + 3) * ngang, 140 + doc1 , 100, 60, chQL0, 8);
	string valueQLINK0 = to_string(QLINK[0]);
	char const* vlQLINK0 = valueQLINK0.c_str();
	frame(320 + (n + 3) * ngang, 140 + doc1, 60, 60, vlQLINK0, 8);
	...
	outtextxy(230, 95, "KIEM TRA COUNT[K] = 0 THI QLINK[R] = K, R = K (1 <= K <= N)");
	setfontcolor(8);
	string chu3 = to_string(F);
	char const* chuF = chu3.c_str();
	frame(200 + (n + 1.5) * ngang, 300, 60, 60, "F", 8);
	frame(210 + (n + 2) * ngang, 300, 60, 60, chuF, 8);
	Sleep(1000);
	frame(200 + (n + 1.5) * ngang, 300, 60, 60, "F", 15);
	frame(210 + (n + 2) * ngang, 300, 60, 60, chuF, 15);

	string chu2 = to_string(N);
	char const* chuN = chu2.c_str();
	frame(200 + (n + 1.5) * ngang, 400, 60, 60, "N", 15);
	frame(210 + (n + 2) * ngang, 400, 60, 60, chuN, 15);
	...
	while (N != 0)
	{
		while (F != 0)
		{
			...
			{
				string chuQLINK = to_string(KQ[i]);
				char const* chuQL = chuQLINK.c_str();
				frame(100 + (n + 3) * ngang + (60 * i), 200 + (n + 2) * 60, 60, 60, chuQL, 15);
			}
			KQ[valueKQ] = F;
			string chu5 = to_string(KQ[valueKQ]);
			char const* chuKQ = chu5.c_str();
			frame(100 + (n + 3) * ngang + (60 * valueKQ), 200 + (n + 2) * 60, 60, 60, chuKQ, 8);
			Sleep(1000);
			frame(100 + (n + 3) * ngang + (60 * valueKQ), 200 + (n + 2) * 60, 60, 60, chuKQ, 15);
			Sleep(1000);
			frame(200 + (n + 1.5) * ngang, 300, 60, 60, "F", 15);
			frame(210 + (n + 2) * ngang, 300, 60, 60, chuF, 15);
			valueKQ++;
			...
			frame(210 + (n + 2) * ngang, 400, 60, 60, chuN, 8);
			frame(100 + (n + 3) * ngang, 140 + (n + 3) * 60, 60, 60, "KQ:", 15);
			for (int i = 1; i < valueKQ; i++)
			{
				string chuQLINK = to_string(KQ[i]);
			...
			while (P1 != NULL)
			{
				...
				if (COUNT[P1->SUC] == 0)
				{
					...
					string chuR3 = to_string(R);
					char const* chR3 = chuR3.c_str();
					frame(200 + (n + 1.5) * ngang, 200, 60, 60, "R", 8);
					frame(210 + (n + 2) * ngang, 200, 60, 60, chR3, 8);
					frame(200 + (n + 1.5) * ngang, 300, 60, 60, "F", 15);
					frame(210 + (n + 2) * ngang, 300, 60, 60, chuF, 15);
					frame(200 + (n + 1.5) * ngang, 400, 60, 60, "N", 15);
					frame(210 + (n + 2) * ngang, 400, 60, 60, chuN, 15);
					...
					Sleep(1000);
					frame(200 + (n + 1.5) * ngang, 200, 60, 60, "R", 15);
					frame(210 + (n + 2) * ngang, 200, 60, 60, chR3, 15);
				}
			...
			chuR = to_string(R);
			chR = chuR.c_str();
			string chF7 = to_string(F);
			char const* chuF7 = chF7.c_str();
			frame(200 + (n + 1.5) * ngang, 200, 60, 60, "R", 15);
			frame(210 + (n + 2) * ngang, 200, 60, 60, chR, 15);
			frame(200 + (n + 1.5) * ngang, 300, 60, 60, "F", 8);
			frame(210 + (n + 2) * ngang, 300, 60, 60, chuF7, 8);
			frame(200 + (n + 1.5) * ngang, 400, 60, 60, "N", 15);
			frame(210 + (n + 2) * ngang, 400, 60, 60, chuN, 15);
			frame(100 + (n + 3) * ngang, 140 + (n + 3) * 60, 60, 60, "KQ:", 15);
			for (int i = 1; i < valueKQ; i++)
			...
			Sleep(1000);
			frame(200 + (n + 1.5) * ngang, 300, 60, 60, "F", 15);
			frame(210 + (n + 2) * ngang, 300, 60, 60, chuF7, 15);
		}
	}
	Sleep(1000);
	setfontcolor(15);
